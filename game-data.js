// Spyfall game data - locations and roles
const GAME_LOCATIONS = [
  {
    name: "Airplane",
    roles: ["First Class Passenger", "Air Marshal", "Mechanic", "Economy Class Passenger", "Stewardess", "Co-Pilot", "Captain"]
  },
  {
    name: "Bank",
    roles: ["Armored Car Driver", "Manager", "Consultant", "Customer", "Robber", "Security Guard", "Teller"]
  },
  {
    name: "Beach",
  ...
  {
    name: "Cathedral",
    roles: ["Priest", "Beggar", "Sinner", "Parishioner", "Tourist", "Sponsor", "Choir Singer"]
  },
  {
    name: "Circus Tent",
  ...
  },
  {
    ...
    roles: ["Entertainer", "Manager", "Unwanted Guest", "Owner", "Secretary", "Accountant", "Delivery Boy"]
  },
  {
    name: "Crusader Army",
    roles: ["Monk", "Imprisoned Arab", "Servant", "Bishop", "Squire", "Archer", "Knight"]
  },
  {
    name: "Day Spa",
  ...
  {
    name: "Movie Studio",
    roles: ["Stunt Man", "Sound Engineer", "Camera Man", "Director", "Costume Artist", "Actor", "Producer"]
  },
  {
    name: "Ocean Liner",
  ...
  {
    name: "Pirate Ship",
    roles: ["Cook", "Sailor", "Slave", "Cannoneer", "Bound Prisoner", "Cabin Boy", "Brave Captain"]
  },
  {
    name: "Polar Station",
  ...
  {
    name: "University",
    roles: ["Graduate Student", "Professor", "Dean", "Psychologist", "Maintenance Man", "Student", "Janitor"]
  }
];
